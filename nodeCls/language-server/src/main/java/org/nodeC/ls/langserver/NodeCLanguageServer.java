...
public class NodeCLanguageServer implements LanguageServer, LanguageClientAware {
    private TextDocumentService textDocumentService;
    private WorkspaceService workspaceService;
    private LanguageClient client;
    private int errorCode = 1;

    public NodeCLanguageServer() {
        this.textDocumentService = new NodeCTextDocumentService();
        this.workspaceService = new NodeCWorkspaceService();
    }
